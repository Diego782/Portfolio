...
{
  title: 'Phone Store',
  exprience: ['SENA', 'Front End Dev', '2023'],
...
for (let i = 0; i < projectDetail.length; i += 1) {
  ...
  <div class="grid-item" id="work-1">
    ...
    <div class="desk-item1"><img style="width:600px; height:400px; border-radius: 8px;" src="${projectDetail[i].image}" alt="my tonic project"></div>
    <div class="desk-col">
